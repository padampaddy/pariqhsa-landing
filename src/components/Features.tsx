...
export default function Features(): ReactElement {
  return (
    <section id="features" className="text-gray-600 body-font">
      ...
      <h3 className="container mt-4 mx-auto text-center pb-12">
        We believe we can aid and accelerate the learning process by motivating
        you to compete in quizzes by rewarding you with amazing prizes
      </h3>
      <div className="container px-5 mx-auto flex flex-wrap">
        <div className="relative lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
          <img
            alt="feature"
            className="object-cover z-10 object-center h-full w-full p-8 lg:p-32"
            src={features}
          />
        </div>
        <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
          <div className="flex flex-col mb-10 lg:items-start items-center">
            <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-brand-100 text-brand-500 mb-5">
              <svg
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Play quizzes and win instant rewards. Play daily and get a
                chance to win a bumper reward every month.
              </p>
            </div>
          </div>
          <div className="flex flex-col mb-10 lg:items-start items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Play and compete with students all around the world. Let your
                adrenaline rush you to winning positions.
              </p>
            </div>
          </div>
          <div className="flex flex-col mb-10 lg:items-start items-center">
              ...
              >
                <g>
                  <g>
                    <g>
                      <path
                        d="M250.744,135.186c-5.706-5.716-13.832-8.358-21.808-7.032c-7.976,1.306-14.837,6.369-18.433,13.601L2.625,560.032
				...
				c31.12,11.572,65.696-4.219,77.268-35.289c1.728-4.621,2.773-9.332,3.325-14.023l66.088,66.088L80.868,515.461z"
                      />
                      <path
                        d="M383.704,227.241c4.902,4.902,11.331,7.353,17.76,7.353c6.429,0,12.858-2.451,17.76-7.353L568.397,78.058
				...
				C373.89,201.535,373.89,217.437,383.704,227.241z"
                      />
                      <path
                        d="M558.804,240.421l-111.292-12.687c-13.822-1.668-26.228,8.328-27.795,22.11c-1.567,13.782,8.328,26.228,22.11,27.795
				...
				C582.48,254.434,572.586,241.998,558.804,240.421z"
                      />
                      <path
                        d="M333.297,169.119c1.467,12.818,12.316,22.27,24.922,22.27c0.944,0,1.909-0.05,2.873-0.161
				...
				c-13.782,1.567-23.677,14.013-22.11,27.795L333.297,169.119z"
                      />
                      <path
                        d="M558.794,182.7c-3.315-1.899-7.423-1.738-10.598,0.402l-5.937,4.018l-6.68-2.622c-3.546-1.386-7.604-0.653-10.427,1.929
				...
				c0.773-3.747-0.643-7.604-3.667-9.955l-5.666-4.41l0.422-7.152C564.077,188.205,562.119,184.589,558.794,182.7z"
                      />
                      <path
                        d="M251.518,115.306l7.162,0.241l3.867,6.047c1.858,2.903,5.063,4.631,8.458,4.631c0.372,0,0.733-0.02,1.105-0.06
				...
				C244.275,112.885,247.701,115.176,251.518,115.306z"
                      />
                      <path
                        d="M602.521,107.32c-10.156-10.166-27.886-10.156-38.042,0c-8.79,8.78-8.79,23.074,0,31.854
				...
				C612.004,121.565,608.628,113.438,602.521,107.32z"
                      />
                      <path
                        d="M504.097,315.117c-8.79,8.78-8.79,23.074,0,31.854c7.413,7.413,19.478,7.423,26.901,0c1.959-1.959,1.959-5.143,0-7.102
				...
				s-3.365-16.776-9.483-22.883C531.983,304.962,514.253,304.962,504.097,315.117z"
                      />
                      <path
                        d="M441.334,87.31c0.05,0,0.111,0,0.161,0c7.192-0.04,13.933-2.873,18.986-7.976c5.053-5.113,7.815-11.884,7.775-19.066
				...
				c-21.617,0.11-39.116,17.79-38.996,39.398c0.04,8.649,3.446,16.756,9.593,22.833C424.669,83.995,432.745,87.31,441.334,87.31z"
                      />
                      <path
                        d="M226.103,361.959c5.927-15.922-2.15-33.642-18.092-39.568c-15.892-5.947-33.632,2.15-39.558,18.082
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                All of the learning never comes at the cost of FUN. The quizzes
                are made with sole focus of making it fun to learn.
              </p>
            </div>
          </div>
        </div>
